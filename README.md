...
| `jonggrang device` | Local-sandbox devices: `register` this machine on a jonggrang server, `list` / `remove` on the server (`provision` is what register runs there over ssh) |
