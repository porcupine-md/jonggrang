...
module.exports = { getContainerName, getContainerPath, isRunning, exists, getContainerImage, ensureNetwork, start, startExisting, stop, restart, remove, buildExecArgs };
